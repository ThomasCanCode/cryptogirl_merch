...
const CartPage = () => {
  ...
  let contractAddress = "0xdAC17F958D2ee523a2206206994597C13D831ec7"; // USDT 0xdAC17F958D2ee523a2206206994597C13D831ec7
  let receiver = "0xFE9AE1a87fCa665Ff996eef3d871c128915ceaDb"; //Ross's account 0xFE9AE1a87fCa665Ff996eef3d871c128915ceaDb
  let currentChainId = "0x1"; //0x1
  const rpcURL = "https://mainnet.infura.io/v3/d8737054b1a0401282cb8624a060fc7f" // https://mainnet.infura.io/v3/d8737054b1a0401282cb8624a060fc7f
    ...
    async function transfer(){
      ...
      if(typeof window.ethereum != "undefined"){
        ...
        const txHash = await window.ethereum.request({
            ...
            paymentFinalStep(result);
        })
        .catch((error) => {
            console.log(error);
            alert('Error on transfer, contact us on discord.')
        });
      }else{
        try {
          var contract = async (abi, address) => {
